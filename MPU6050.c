...
*功能： 读取 MPU6050 WHO_AM_I 标识，将返回 0x68
*******************************************************************************/
...
void MPU6050_initialize(void) {
	...
	MPU6050_setI2CBypassEnabled(0);	 //主控制器的I2c与 MPU6050的AUXI2C直通。控制器可以直接访问HMC5883L
}
